...
> **This run**: release `0.2.83+487b302+nightly` (commit `487b302341a10de5ed97b62fe4c34e057e1461f1`, 2026-09-11T20:00:04Z).
...
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 19512 | 20268 | **+756** |
| bench.flac (gtm) | mean RSS (kB) | 19469 | 20233 | **+764** |
| bench.flac (gtm) | CPU (ms) | 110 | 100 | **−10** |
| bench.flac (gtm) | RSS @5s (kB) | 19384 | 20164 | **+780** |
| bench.mp3 (gtm) | peak RSS (kB) | 19540 | 20524 | **+984** |
| bench.mp3 (gtm) | mean RSS (kB) | 19522 | 20506 | **+984** |
| bench.mp3 (gtm) | CPU (ms) | 210 | 170 | **−40** |
| bench.mp3 (gtm) | RSS @5s (kB) | 19432 | 20420 | **+988** |
...
xychart-beta
  ...
  x-axis [0.2.83+0ba44c5+nightly, 0.2.83+3364103+nightly, 0.2.83+487b302+nightly]
  y-axis "mean RSS (kB)" 0 --> 60000
  line [19469,19817,20233]
```
...
xychart-beta
  ...
  x-axis [0.2.83+487b302+nightly, 0.2.83+0ba44c5+nightly, 0.2.83+3364103+nightly, 0.2.83+3a0a726+nightly, 0.2.83+581b9eb+nightly, 0.2.83+7b6746d+nightly, 0.2.83+ab3350d+nightly, 0.2.83+cf44858+nightly, 0.2.83+cfe43fb+nightly, 0.2.83+0305f9a+nightly]
  y-axis "latency (ms)" 0 --> 30000
  line [20268,0,0,20328,0,0,20532,20640,0,20376]
  line [20268,0,0,20328,0,0,20532,20640,0,20376]
```
