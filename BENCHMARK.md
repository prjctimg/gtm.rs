...
> **This run**: release `0.2.83+d780bd2+nightly` (commit `d780bd216a9651b5059718e68495b105df705745`, 2026-09-19T08:21:30Z).

## Headline — diff vs the last published release (`0.2.83+354d495+nightly`)

| Fixture (player) | Metric | Prev (`0.2.83+354d495+nightly`) | This | Δ |
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 17792 | 17540 | **−252** |
| bench.flac (gtm) | mean RSS (kB) | 17751 | 17499 | **−252** |
| bench.flac (gtm) | CPU (ms) | 100 | 130 | **+30** |
| bench.flac (gtm) | RSS @5s (kB) | 17672 | 17420 | **−252** |
...
xychart-beta
  ...
  line [19449,19817,19469,20097,19993,20597,20489,20333,20293,20233,20593,20805,20746,20514,17683,17679,17596,18113,17855,17800,18063,17751,17499]
```
...
xychart-beta
  ...
  line [71,70,71,69,71,66,67,70,66,70,67,67,71,71,65,70,69,64,70,68,65,14,18]
```
