...
> **This run**: release `0.2.83+0ba44c5+nightly` (commit `0ba44c500b35a5321172f2929fbf43fd4de64434`, 2026-09-09T05:31:12Z).
...
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 19492 | 19512 | **+20** |
| bench.flac (gtm) | mean RSS (kB) | 19449 | 19469 | **+20** |
| bench.flac (gtm) | CPU (ms) | 120 | 110 | **−10** |
| bench.flac (gtm) | RSS @5s (kB) | 19364 | 19384 | **+20** |
| bench.mp3 (gtm) | peak RSS (kB) | 19924 | 19540 | **−384** |
| bench.mp3 (gtm) | mean RSS (kB) | 19905 | 19522 | **−383** |
| bench.mp3 (gtm) | CPU (ms) | 210 | 210 | 0 |
| bench.mp3 (gtm) | RSS @5s (kB) | 19816 | 19432 | **−384** |
...
xychart-beta
  ...
  x-axis [0.2.83+cfe43fb+nightly, 0.2.83+3364103+nightly, 0.2.83+0ba44c5+nightly]
  y-axis "mean RSS (kB)" 0 --> 60000
  line [19449,19817,19469]
```
