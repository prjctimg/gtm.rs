...
> **This run**: release `0.2.83+0db6b8f+nightly` (commit `0db6b8fc37cd75b93fe6d0d80eaa7a797ca6b35c`, 2026-09-19T21:07:46Z).

## Headline — diff vs the last published release (`0.2.83+29ca322+nightly`)

| Fixture (player) | Metric | Prev (`0.2.83+29ca322+nightly`) | This | Δ |
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 17424 | 17676 | **+252** |
| bench.flac (gtm) | mean RSS (kB) | 17384 | 17635 | **+251** |
| bench.flac (gtm) | CPU (ms) | 120 | 130 | **+10** |
| bench.flac (gtm) | RSS @5s (kB) | 17304 | 17556 | **+252** |
...
xychart-beta
  ...
  line [19449,19817,19469,20097,19993,20597,20489,20333,20293,20233,20593,20805,20746,20514,17683,17679,17596,18113,17855,17800,18063,17751,17499,17384,17635]
```
...
xychart-beta
  ...
  line [71,70,71,69,71,66,67,70,66,70,67,67,71,71,65,70,69,64,70,68,65,14,18,17,16]
```
