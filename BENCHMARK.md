...
> **This run**: release `0.2.83+e5d8a6f+nightly` (commit `e5d8a6fa335a05c25b6cb8d1777d2684c2ffb88e`, 2026-09-19T23:02:14Z).

## Headline — diff vs the last published release (`0.2.83+0db6b8f+nightly`)

| Fixture (player) | Metric | Prev (`0.2.83+0db6b8f+nightly`) | This | Δ |
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 17676 | 18272 | **+596** |
| bench.flac (gtm) | mean RSS (kB) | 17635 | 18232 | **+597** |
| bench.flac (gtm) | CPU (ms) | 130 | 120 | **−10** |
| bench.flac (gtm) | RSS @5s (kB) | 17556 | 18152 | **+596** |
...
xychart-beta
  ...
  line [19449,19817,19469,20097,19993,20597,20489,20333,20293,20233,20593,20805,20746,20514,17683,17679,17596,18113,17855,17800,18063,17751,17499,17384,17635,18232]
```
...
xychart-beta
  ...
  line [71,70,71,69,71,66,67,70,66,70,67,67,71,71,65,70,69,64,70,68,65,14,18,17,16,17]
```
