...
> **This run**: release `0.2.83+29ca322+nightly` (commit `29ca322be52809a5cdbbb9419b5281ae62b7ccd5`, 2026-09-19T20:12:22Z).

## Headline — diff vs the last published release (`0.2.83+d780bd2+nightly`)

| Fixture (player) | Metric | Prev (`0.2.83+d780bd2+nightly`) | This | Δ |
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 17540 | 17424 | **−116** |
| bench.flac (gtm) | mean RSS (kB) | 17499 | 17384 | **−115** |
| bench.flac (gtm) | CPU (ms) | 130 | 120 | **−10** |
| bench.flac (gtm) | RSS @5s (kB) | 17420 | 17304 | **−116** |
...
xychart-beta
  ...
  line [19449,19817,19469,20097,19993,20597,20489,20333,20293,20233,20593,20805,20746,20514,17683,17679,17596,18113,17855,17800,18063,17751,17499,17384]
```
...
xychart-beta
  ...
  line [71,70,71,69,71,66,67,70,66,70,67,67,71,71,65,70,69,64,70,68,65,14,18,17]
```
