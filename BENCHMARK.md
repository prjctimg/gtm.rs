...
> **This run**: release `0.2.83+8d4ac02+nightly` (commit `8d4ac02867e913484b3feb4c11fc5d4800ed7265`, 2026-09-20T01:13:52Z).

## Headline — diff vs the last published release (`0.2.83+e5d8a6f+nightly`)

| Fixture (player) | Metric | Prev (`0.2.83+e5d8a6f+nightly`) | This | Δ |
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 18272 | 18240 | **−32** |
| bench.flac (gtm) | mean RSS (kB) | 18232 | 18200 | **−32** |
| bench.flac (gtm) | CPU (ms) | 120 | 70 | **−50** |
| bench.flac (gtm) | RSS @5s (kB) | 18152 | 18120 | **−32** |
...
xychart-beta
  ...
  line [19449,19817,19469,20097,19993,20597,20489,20333,20293,20233,20593,20805,20746,20514,17683,17679,17596,18113,17855,17800,18063,17751,17499,17384,17635,18232,18200]
```
...
xychart-beta
  ...
  line [71,70,71,69,71,66,67,70,66,70,67,67,71,71,65,70,69,64,70,68,65,14,18,17,16,17,12]
```
