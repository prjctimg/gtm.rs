...
> **This run**: release `0.2.83+03962c3+nightly` (commit `03962c3fa90da6de3f76d8dbeef000cbdacc23df`, 2026-09-14T18:18:22Z).

## Headline — diff vs the last published release (`0.2.83+d84752d+nightly`)

| Fixture (player) | Metric | Prev (`0.2.83+d84752d+nightly`) | This | Δ |
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 17724 | 17720 | **−4** |
| bench.flac (gtm) | mean RSS (kB) | 17683 | 17679 | **−4** |
| bench.flac (gtm) | CPU (ms) | 110 | 120 | **+10** |
| bench.flac (gtm) | RSS @5s (kB) | 17604 | 17600 | **−4** |
...
xychart-beta
  ...
  x-axis [0.2.83+cfe43fb+nightly, 0.2.83+3364103+nightly, 0.2.83+0ba44c5+nightly, 0.2.83+581b9eb+nightly, 0.2.83+7b6746d+nightly, 0.2.83+cf44858+nightly, 0.2.83+ab3350d+nightly, 0.2.83+0305f9a+nightly, 0.2.83+3a0a726+nightly, 0.2.83+487b302+nightly, 0.2.83+3e10016+nightly, 0.2.83+1d3fd86+nightly, 0.2.83+ff13d58+nightly, 0.2.83+dca7ff3+nightly, 0.2.83+d84752d+nightly, 0.2.83+03962c3+nightly]
  y-axis "peak RSS (kB)" 0 --> 30000
  bar [19492,19860,19512,20140,20036,20640,20532,20376,20328,20268,20628,20840,20780,20548,17724,17720]
```
...
xychart-beta
  ...
  line [71,70,71,69,71,66,67,70,66,70,67,67,71,71,65,70]
```
