...
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 19512 | 20780 | **+1268** |
| bench.flac (gtm) | mean RSS (kB) | 19469 | 20746 | **+1277** |
| bench.flac (gtm) | CPU (ms) | 110 | 130 | **+20** |
| bench.flac (gtm) | RSS @5s (kB) | 19384 | 20676 | **+1292** |
| bench.mp3 (gtm) | peak RSS (kB) | 19540 | 20880 | **+1340** |
| bench.mp3 (gtm) | mean RSS (kB) | 19522 | 20863 | **+1341** |
| bench.mp3 (gtm) | CPU (ms) | 210 | 230 | **+20** |
| bench.mp3 (gtm) | RSS @5s (kB) | 19432 | 20776 | **+1344** |
...
xychart-beta
  ...
  x-axis [0.2.83+0ba44c5+nightly, 0.2.83+1d3fd86+nightly, 0.2.83+ff13d58+nightly]
  y-axis "mean RSS (kB)" 0 --> 60000
  line [19469,20805,20746]
```
...
xychart-beta
  ...
  x-axis [0.2.83+ff13d58+nightly, 0.2.83+0ba44c5+nightly, 0.2.83+1d3fd86+nightly, 0.2.83+3364103+nightly, 0.2.83+3a0a726+nightly, 0.2.83+3e10016+nightly, 0.2.83+487b302+nightly, 0.2.83+581b9eb+nightly, 0.2.83+7b6746d+nightly, 0.2.83+ab3350d+nightly, 0.2.83+cf44858+nightly, 0.2.83+cfe43fb+nightly, 0.2.83+0305f9a+nightly]
  y-axis "latency (ms)" 0 --> 30000
  line [20780,0,20840,0,20328,20628,20268,0,0,20532,20640,0,20376]
  line [20780,0,20840,0,20328,20628,20268,0,0,20532,20640,0,20376]
```
...
|---------|------|-----:|
| 0.2.83+ff13d58+nightly | 2026-09-13 | 20780 |
| 0.2.83+0ba44c5+nightly | 2026-09-09 | 19512 |
| 0.2.83+1d3fd86+nightly | 2026-09-13 | 20840 |
