...
> **This run**: release `0.2.83+1d3fd86+nightly` (commit `1d3fd8603feea2f4d393859502fc9cbb62f35c36`, 2026-09-13T09:36:04Z).
...
|------------------|--------|------:|-----:|---:|
| bench.flac (gtm) | peak RSS (kB) | 19512 | 20840 | **+1328** |
| bench.flac (gtm) | mean RSS (kB) | 19469 | 20805 | **+1336** |
| bench.flac (gtm) | CPU (ms) | 110 | 120 | **+10** |
| bench.flac (gtm) | RSS @5s (kB) | 19384 | 20736 | **+1352** |
| bench.mp3 (gtm) | peak RSS (kB) | 19540 | 21100 | **+1560** |
| bench.mp3 (gtm) | mean RSS (kB) | 19522 | 21082 | **+1560** |
| bench.mp3 (gtm) | CPU (ms) | 210 | 210 | 0 |
| bench.mp3 (gtm) | RSS @5s (kB) | 19432 | 20996 | **+1564** |
...
xychart-beta
  ...
  x-axis [0.2.83+0ba44c5+nightly, 0.2.83+3364103+nightly, 0.2.83+1d3fd86+nightly]
  y-axis "mean RSS (kB)" 0 --> 60000
  line [19469,19817,20805]
```
...
xychart-beta
  ...
  x-axis [0.2.83+1d3fd86+nightly, 0.2.83+0ba44c5+nightly, 0.2.83+3364103+nightly, 0.2.83+3a0a726+nightly, 0.2.83+3e10016+nightly, 0.2.83+487b302+nightly, 0.2.83+581b9eb+nightly, 0.2.83+7b6746d+nightly, 0.2.83+ab3350d+nightly, 0.2.83+cf44858+nightly, 0.2.83+cfe43fb+nightly, 0.2.83+0305f9a+nightly]
  y-axis "latency (ms)" 0 --> 30000
  line [20840,0,0,20328,20628,20268,0,0,20532,20640,0,20376]
  line [20840,0,0,20328,20628,20268,0,0,20532,20640,0,20376]
```
