# Spec 05: Documentation — Termux Build & Usage Guide

## Summary

Add Termux/Android build instructions and usage documentation to `README.md` (summary) and a new `docs/termux.md` (detailed guide). Covers prerequisites, PulseAudio setup, on-device builds, cross-compilation, troubleshooting, and background playback restrictions.

## Changes to `README.md`

Add a new section after the existing "Nix" install section (after line 76 in current README):
...
|---|---|---|
| `README.md` | Modify | Add Termux install section after Nix section |
| `docs/termux.md` | **New** | Full Termux guide (~200 lines) |
